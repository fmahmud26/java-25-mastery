...
At 1k RPS, p99 means ~10 slow requests/s. “Average 5ms” with “p99 2s” fails the product.
...
[latency.md](./latency.md) · [incidents.md](./incidents.md) · [gc-pressure.md](./gc-pressure.md)
